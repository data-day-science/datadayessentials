...
class ColumnRenamer(IDataFrameTransformer):
    ...
    ```python
    from datadayessentials.data_transformation import ColumnRenamer
...
class TierMapper(IDataFrameTransformer):
    ...
    Typical usage example:
    ```python
    from datadayessentials.data_transformation import TierMapper
...
class InvalidPayloadDropperByPrefix(IDataFrameTransformer):
    ...
    Example Use Case:
    ```python
    from datadayessentials.data_transformation import InvalidPayloadDropperByPrefix
