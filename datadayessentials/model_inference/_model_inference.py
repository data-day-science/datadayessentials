...
class ScorecardServiceHitter(GenericServiceHitter):
    ...
    Example Use Case:
    ```python
    from datadayessentials.model_inference import ScorecardBatchEndpoint
    from datadayessentials.data_retrieval import CreditDataLoader
...
class PrimePredictionsServiceHitter(GenericServiceHitter):
    ...
    Example Use Case:
    ```python
    from datadayessentials.model_inference import PrimePredictionsServiceHitter
    from datadayessentials.data_retrieval import CreditDataLoader
    from datadayessentials.authentications import DataLakeAuthentication
