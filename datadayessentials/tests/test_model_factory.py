...
class TestModelFactory(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_model = CatBoostClassifierPipeline(
            cat_features=["col4"], **model_params
        )
        ...
        model_info = model_manager.register_model_from_run_id(
            cls.run_id, cls.registered_model_name, "model"
        )
    ...
    def test_create_from_registered_model(self):
        ...
        loaded_model = model_factory.create_from_registered_model(
            self.registered_model_name, self.model_version
        )
