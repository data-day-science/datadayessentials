...
1. Clone the repository to your local computer.  From there, cd to the root of datascience_core and activate the virtual env of interest
```bash
cd C:\\Users.....datascience_core
...
```bash 
conda activate <MY_ENV>
pip install git+https://github.com/Carfinance247/datascience_core.git@v0.1
```
...
```
git clone https://github.com/Carfinance247/datascience_core
cd datascience_core
pip install -e .
```
## Config Setup
...
from datascience_core.config import ConfigContentUpdater
...
from datascience_core.config import (
    LocalConfig,
    GlobalConfig,
    ConfigManager,
...
import os
from pathlib import Path
from datascience_core.utils import set_global_loggers_to_warning
from datascience_core.config import ConfigSetup
