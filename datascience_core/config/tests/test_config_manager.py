...
class TestConfigManager:
    ...
    def config_manager(self, mock_local_config, mock_project_dataset_manager):
        with patch('datascience_core.config._config_manager.LocalConfig', return_value=mock_local_config):
            with patch('datascience_core.config._config_manager.ProjectDatasetManager', return_value=mock_project_dataset_manager):
                yield ConfigManager()
