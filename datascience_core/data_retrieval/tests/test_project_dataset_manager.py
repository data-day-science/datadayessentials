...
class TestProjectDatasetManager(unittest.TestCase):
    ...
    @mock.patch(
        "datascience_core.data_retrieval._project_dataset_manager.DatalakeProjectAssetsHelper"
    )
    @mock.patch(
        "datascience_core.data_retrieval._project_dataset_manager.DataLakePickleSaver"
    )
    ...
    @mock.patch(
        "datascience_core.data_retrieval._project_dataset_manager.DataLakeCSVSaver"
    )
    ...
    @mock.patch(
        "datascience_core.data_retrieval._project_dataset_manager.DataLakeJsonSaver"
    )
