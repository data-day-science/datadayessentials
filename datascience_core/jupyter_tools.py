...
from datascience_core.authentications import DatabaseAuthentication
...
def set_screen_width(pecent_width: int = 90):
    ...
    Example Use Case:
    ```
    from datascience_core.utils import set_screen_width
...
def show_df(df: pd.DataFrame, allRows: bool = False):
    ...
    Example Use Case:
    ```
    from datascience_core.utils import show_df
