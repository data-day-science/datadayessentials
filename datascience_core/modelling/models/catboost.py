...
class CatBoostClassifierPipeline(IModel, IModelSavingLoadingAttribute):
    ...
    from datascience_core.models import CatBoostClassifierPipeline
    from datascience_core.utils import ModelEvaluator
    from datascience_core.data_transformation import ValueReplacer, CatTypeCoverter, DataFramePipe
    ...
    pipeline = CatBoostClassifierPipeline(
    ...
    def __init__(
        ...
        **kw,
        ...
        if model is not None:
            ...
            self.model = CatBoostClassifier(**kw)
    ...
    def predict_proba(
        ...
        return self.predict_proba(
            X, ntree_start, ntree_end, thread_count, verbose, task_type
        )
    ...
    def run_cross_validation(
        ...
        **kwargs,
        ...
        cv_dataset = Pool(
            data=X, label=y, cat_features=self.model.get_params()["cat_features"]
        )
