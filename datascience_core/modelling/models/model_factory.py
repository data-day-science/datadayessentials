from datascience_core.modelling.models._base import IModelSavingLoadingAttribute
from datascience_core.modelling.model_manager import ModelManager
from datascience_core.config import LocalConfig
import os
from datascience_core.modelling.models._base import IModelFactory

class ModelFactory(IModelFactory):
    """
    Class for loading models stored as either azure runs or an azure registered model. Can be used to load these models into any one of the model wrapping classes in datascience_core.modelling.models package.
